    ...
    <div className="2xl:container mx-auto mt-1 ">
      <div className="w-[90%] mx-auto grid grid-cols-1 md:grid-cols-2 h-[10vh] ">
        <div className="flex flex-row items-center justify-between">
          <img
            src="https://ik.imagekit.io/jap5d6wbb/image/new-Ecom.jpg?updatedAt=1748169227581"
            alt="logo"
            className="h-[80px] md:h-[110px] hover:scale-95 transition-transform duration-500 rounded-lg cursor-pointer"
          />
        ...
        <div
          ...
          } md:flex flex-col md:flex-row items-center justify-center gap-4 md:gap-12 bg-slate-800 rounded-lg py-4 px-2  md:h-[10vh]`}
        >
          {["Home", "Contact", "Products", "About"].map((item) => (
            <p
              key={item}
